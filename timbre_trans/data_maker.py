...
parser.add_argument("--samplerate", type=int, default=12800, help='')
...
parser.add_argument("--traindatasets", type=str, default='/data/traindatasets_small', help='')
parser.add_argument("--validdatasets", type=str, default='/data/validdatasets_small', help='')
...
if __name__ == "__main__":
    ...
    cout = make_datasets(path, output_file,tag='train',nums=100000)
